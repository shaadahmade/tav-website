...
export const Problem: React.FC = () => {
  return (
    <section id="problem" className="bg-white relative z-10 rounded-t-[2.5rem] md:rounded-t-[5rem] -mt-20 md:-mt-48 pb-10 md:pb-20">
      <div className="pt-24 md:pt-64 overflow-hidden relative">
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-7xl">
            <Reveal variant="up" width="100%">
              <div className="flex flex-col items-start gap-0 -mt-10 scale-[0.55] sm:scale-75 md:scale-100 origin-top-left">
                <MagicTextReveal 
